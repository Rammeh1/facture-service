...
public class FactureRestController {
	...
	public FactureRestController(FactureRepository factureRepository, ClientServiceClient clientServiceClient,
	...
	public Facture getFacture(@PathVariable(name = "id") Long id) {
		...
		Client client = clientServiceClient.findClientById(id);
